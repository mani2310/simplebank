...
func (q *Queries) CreateAccountAndReturnId(ctx context.Context, arg CreateAccountAndReturnIdParams) (Account, error) {
	row := q.db.QueryRowContext(ctx, createAccountAndReturnId, arg.Owner, arg.Balance, arg.Currency)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
